...
class OasisProfileGenerator:
    ...
    # Group/institutional entity types (require generating representative group personas)
    GROUP_ENTITY_TYPES = [
    ...
    def _search_zep_for_entity(self, entity: EntityNode) -> Dict[str, Any]:
        ...
        searched separately and then merged. Parallel requests are used for efficiency.
        ...
        # graph_id is required to perform search
    ...
    def _try_fix_json(self, content: str, entity_name: str, entity_type: str, entity_summary: str = "") -> Dict[str, Any]:
        ...
        if json_match:
            ...
            try:
                ...
                # 5. If still failing, try a more aggressive fix
                try:
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        """Get system prompt"""
        base_prompt = "You are an expert in generating social media user profiles. Generate detailed, realistic personas for public opinion simulation, faithfully reproducing known real-world circumstances. You must return valid JSON format, and all string values must not contain unescaped newline characters. Use English."
        return base_prompt
    ...
    def _build_individual_persona_prompt(
        ...
        return f"""Generate a detailed social media user persona for the entity, faithfully reproducing known real-world circumstances.
...
2. persona: Detailed persona description (2000 words of plain text), must include:
   ...
   - Personal memories (an important part of the persona: describe this individual's connection to events, and their existing actions and reactions in those events)
...
"""
    ...
    def _build_group_persona_prompt(
        ...
        """Build detailed persona prompt for a group/institutional entity"""

        attrs_str = json.dumps(entity_attributes, ensure_ascii=False) if entity_attributes else "None"
        context_str = context[:3000] if context else "No additional context"

        return f"""Generate a detailed social media account profile for an institutional/group entity, faithfully reproducing known real-world circumstances.
...
2. persona: Detailed account profile description (2000 words of plain text), must include:
   ...
   - Institutional memories (an important part of the institutional persona: describe this institution's connection to events, and its existing actions and reactions in those events)
...
- Institutional account communications must match their identity and positioning"""
    ...
    def generate_profiles_from_entities(
        ...
        completed_count = [0]  # Use a list to allow modification within closure
        lock = Lock()
