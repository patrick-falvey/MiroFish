...
class PanoramaResult:
    ...
    def to_text(self) -> str:
        ...
        if self.active_facts:
            text_parts.append(f"\n### [Currently Active Facts] (original simulation results)")
...
class ZepToolsService:
    ...
    def _local_search(
        ...
        Retrieves all edges/nodes, then performs local keyword matching
    ...
    def get_all_edges(self, graph_id: str, include_temporal: bool = True) -> List[EdgeInfo]:
        """
        Get all edges from a graph (with pagination, including temporal info)
    ...
    def _generate_sub_queries(
        ...
        """
        system_prompt = """You are a professional question analysis expert. Your task is to decompose a complex question into multiple sub-queries that can be independently observed in the simulated world.
...
Return a JSON-formatted list of sub-queries."""
    ...
    def panorama_search(
        ...
        This tool is suitable for scenarios where you need to understand the full picture of events and trace evolution.
    ...
    def interview_agents(
        ...
        [Use Cases]
        - Need perspectives from different roles on events
...
Please generate 3-5 interview questions."""
    ...
    def _generate_interview_summary(
        ...
        system_prompt = """You are a professional news editor. Based on multiple respondents' answers, generate an interview summary.

Summary requirements:
1. Distill main viewpoints from all parties
2. Identify consensus and divergences in viewpoints
...
- Use quotation marks when citing respondents' exact words
