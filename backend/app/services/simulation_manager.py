...
Manages parallel simulations across Twitter and Reddit platforms
    ...
    def prepare_simulation(
        ...
        try:
            ...
            if filtered.filtered_count == 0:
                ...
                state.error = "No matching entities found, please check that the graph is correctly built"
                self._save_simulation_state(state)
                return state
            ...
            # Set up real-time save file path (prefer Reddit JSON format)
