    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even with just a single passage of text, <span class=”highlight-bold”>MiroFish</span> can extract reality seeds and auto-generate a parallel world composed of up to <span class=”highlight-orange”>millions of Agents</span>. Inject variables from a god's-eye view to find the <span class=”highlight-code”>”local optimum”</span> within complex group interactions in dynamic environments.
            </p>
            <p class=”slogan-text”>
              Let the future rehearse among Agents; let decisions triumph after a hundred battles<span class=”blinking-cursor”>_</span>
            </p>
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Prediction engine standing by. Upload unstructured data files to initialize a simulation sequence.
          </p>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity/relationship extraction & persona generation & environment config with Agent injection parameters</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter your simulation or prediction requirement in natural language (e.g., What public opinion trends would emerge if a university revokes a controversial disciplinary action?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
